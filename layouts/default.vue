          ...
          <nav class="hidden lg:flex items-center justify-center flex-1 mx-4 lg:mx-12">
            <div class="flex items-center space-x-1 lg:space-x-4 xl:space-x-6">
              ...
              <NuxtLink
                ...
                :to="localePath('/sell')"
                class="flex items-center px-3 lg:px-4 py-2 bg-gradient-to-r from-red-600 to-red-800 text-white font-semibold rounded-xl hover:from-red-700 hover:to-red-900 shadow-md transition-all duration-200 text-sm lg:text-base whitespace-nowrap"
              >
          ...
          <div class="hidden lg:flex items-center space-x-2 lg:space-x-3 shrink-0">
            ...
            <template v-else-if="currentUser">
              ...
              >
                ...
                <span v-if="unreadCount > 0" class="absolute top-0 right-0 bg-red-600 text-white text-xs rounded-full h-4 w-4 flex items-center justify-center leading-none">
          ...
          <div class="flex flex-col py-2">
            ...
            <div class="border-t border-red-100 mt-1">
              ...
              <template v-else-if="currentUser">
                ...
                <button @click="handleLogout" @touchstart="handleLogout" class="mobile-nav-link w-full text-left text-red-700 hover:bg-red-100 hover:text-red-900 active:bg-red-100">
